...
public class JedisUtil {
  ...
  /**
   * Set Object (默认存活时间不过期)
   *
   * @param key
   * @param obj
   * @return
   */
  public static String setPermanent(String key, Object obj) {
    return setForeverObjectValue(key, obj);
  }
